...
// Update showNotificationModal to add keyboard support
const originalShowNotificationModal = window.showNotificationModal;
window.showNotificationModal = (title, message) => {
    originalShowNotificationModal(title, message);
